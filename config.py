...
REAL_URL_AMENITY = f"{PMS_BASE_URL_EXTERNAL}/room-"  # 💡 小美犀核心帳務 URL 基底，後續會在此基礎上拼接具體功能路徑

# 2. ⚡ 核心擴充：小美犀 5 支核心 API 遠端 URL 矩陣
REAL_URL_BR_ROOM_NOS   = f"{REAL_URL_AMENITY}pay/room-nos"
REAL_URL_BR_MIFARE_NOS = f"{REAL_URL_AMENITY}pay/mifare-nos"
REAL_URL_BR_ROOM_PAY   = f"{REAL_URL_AMENITY}pay/room-pay"
REAL_URL_BR_PAY_CANCEL = f"{REAL_URL_AMENITY}pay/room-pay-cancel"
REAL_URL_BR_BILLING    = f"{REAL_URL_AMENITY}pay/room-billing"

# 3. 🎯 關鍵調整：小美犀專屬遠端 Parameters 查詢參數
REAL_PARAMS_AMENITY = {
    "hotel": "01",
    "athena": "16",
    "thirdParty": "BR"  # 💡 完美對齊小美犀廠商代碼，確保帳務能精準落入 PMS 傳輸日誌 (BR | AIELLO)
}
